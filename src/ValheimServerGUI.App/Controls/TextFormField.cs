...
/// <summary>Functional code for <see cref="TextFormField"/> (properties + value change), split from the
/// XAML-paired code-behind in <c>TextFormField.axaml.cs</c>.</summary>
public partial class TextFormField : IFormField<string?>
{
