...
/// <summary>Functional code for <see cref="LabelField"/> (properties + value change), split from the
/// XAML-paired code-behind in <c>LabelField.axaml.cs</c>.</summary>
public partial class LabelField : IFormField<string>
{
