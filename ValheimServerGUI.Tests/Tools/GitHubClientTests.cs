...
{
    /// <summary>
    /// Locks the release-selection contract that update notifications rely on. Notifications are
    /// only surfaced for the release <see cref="GitHubClient.SelectLatestRelease"/> returns, and it
    ...
    public class GitHubClientTests
    {
        ...
        // The strategy under test: a release-candidate version published as an ORDINARY release
        // (Prerelease = false) is selected, while a newer build flagged as a GitHub pre-release is
        // ignored. This is why publishing 2.4.0-rc.1 as a full release notifies existing users.
        [Fact]
        ...
        // Among eligible releases the most recently published wins; drafts and asset-less releases
        // are skipped even when they are newer.
        [Fact]
